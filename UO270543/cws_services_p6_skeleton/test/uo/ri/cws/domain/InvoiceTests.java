...
public class InvoiceTests {
	...
	/**
	 * Right computation of the invoice amount ( 250 € + IVA 21%)
	 */
	@Test
	...
	public void testNewAmountAfterAddingWorkOrder() {
		...
		System.out.println("testNewAmountAfterAddingWorkOrder: " + invoice.getAmount());
		assertTrue( invoice.getAmount() ==  302.5 );
	}
	...
	public void testInvoiceAmountAddingTwoWorkOrders() {
		...
		System.out.println("testInvoiceAmountAddingTwoWorkOrders: " +invoice.getAmount());
